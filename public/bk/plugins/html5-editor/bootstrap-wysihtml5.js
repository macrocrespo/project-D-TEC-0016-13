!function($, wysi) {
    ...
    var tpl = {
        ...
        "text-align": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-command='justifyLeft' title='" + locale.align.left + "'><i class='fas fa-align-left'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='justifyCenter' title='" + locale.align.center + "'><i class='fas fa-align-center'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='justifyRight' title='" + locale.align.right + "'><i class='fas fa-align-right'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" + 
                "<a class='btn" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "'><i class='fas fa-code'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn dropdown-toggle" + size + "' data-toggle='dropdown' href='#'>" +
                "<span class='current-color'>Colores</span>&nbsp;<b class='caret'></b>" +
              "</a>" +
              "<ul class='dropdown-menu'>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: [site_url+"bk/plugins/html5-editor/wysiwyg-color.css", site_url+"bk/css/style.css"],
        locale: "es"
    };
    ...
    var locale = $.fn.wysihtml5.locale = {
        ...
        es: {
            ...
            lists: {
                ...
                outdent: "Disminuir margen",
                indent: "Aumentar margen"
            },
            link: {
                insert: "Insert link",
                cancel: "Cancelar"
