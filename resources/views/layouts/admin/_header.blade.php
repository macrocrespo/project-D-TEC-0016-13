            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <img src="{{ asset('bk/images/users/04.png') }}" alt="user" class="rounded-circle" width="31">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <span class="with-arrow">
                            <span class="bg-warning"></span>
                        </span>
                        <div class="d-flex no-block align-items-center p-15 bg-warning text-white m-b-10">
                            <div class="">
                                <img src="{{ asset('bk/images/users/04.png') }}" alt="{{ $user->name }}" class="img-circle" width="60">
                            </div>
                            <div class="m-l-10">
