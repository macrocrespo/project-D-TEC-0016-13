...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            {{ Backend::card(array('title'=>'Listado de usuarios', 'icon'=>'fa fa-angle-double-right')) }}
                <p class="text-muted m-b-20">Desde aquí puede agregar, editar y eliminar usuarios.</p>

                <?php Backend::btn_create(array('route'=>'usuarios.create', 'text'=>'Agregar usuario')); ?>
